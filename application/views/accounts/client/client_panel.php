...
<!-- This are a close to navbar from navbar_home -->
        ...
        <a id="logo-container" href="<?php echo base_url();?>" class="brand-logo">Client</a>
    </div>
</nav>
...
<div class="container" style="padding-top: 2rem">
	...
	<div class="row margin">
        <a type="button" class="btn right waves-effect waves-light" href="<?php echo base_url('client/client_create'); ?>">
