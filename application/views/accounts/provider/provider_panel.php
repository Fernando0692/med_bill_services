...
<!-- This are a close to navbar from navbar_home -->
        ...
        <a id="logo-container" href="<?php echo base_url();?>" class="brand-logo">Provider</a>
    </div>
</nav>
...
<div class="container" style="padding-top: 2rem">
	...
	<div class="row margin">
        <a type="button" class="btn right waves-effect waves-light" href="<?php echo base_url('provider/provider_create'); ?>">
            ...
            <table class="highlight responsive-table">
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="laboral_status">Specialty</th>
                    </tr>
                </thead>
                <tbody>
