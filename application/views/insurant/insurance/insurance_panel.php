...
<!-- This are a close to navbar from navbar_home -->
        ...
        <a id="logo-container" href="<?php echo base_url();?>" class="brand-logo">Insurance</a>
    </div>
</nav>
...
<div class="container" style="padding-top: 2rem">
	...
	<div class="row margin">
        <a type="button" class="btn right waves-effect waves-light" href="<?php echo base_url('insurance/insurance_create'); ?>">
            ...
            <table class="highlight responsive-table">
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="fname">Name / Company</th>
                        <th data-field="lname">Phone</th>
                        <th data-field="insurance_plan">Adress</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach($result as $r): ?>
                        <tr class='dropdown-button' data-activates="options">
                            <td><?php echo $r->id_insurance; ?></td>
                            <td><?php echo $r->name; ?></td>
                            <td><?php echo $r->phone; ?></td>
                            <td><?php echo $r->street.' '.$r->city.' '.$r->state.' '.$r->zip_code; ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
