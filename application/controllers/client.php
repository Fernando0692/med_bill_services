...
class client extends CI_Controller
{
	...
	function index()
	{
		$data['result'] = $this->client_model->get_client_info();
        $this->load->view('accounts/client/client_panel', $data);
	}

	function client_create()
	{
		$this->load->view('accounts/client/client_create');
	}
